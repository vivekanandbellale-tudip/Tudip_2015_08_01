...
namespace ShrikantShiledar
{
	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			for (var countOfSlot = 1; countOfSlot < noOfTimeSlot; countOfSlot++)
			{
				Time t = new Time();
				...
				//Console.WriteLine("Please enter ending hours  in {1} timeslot:", countOfSlot);
				t.endHours = int.Parse(Console.ReadLine());
				//Console.WriteLine("Please enter ending minutes in {1} timeslot:", countOfSlot);
