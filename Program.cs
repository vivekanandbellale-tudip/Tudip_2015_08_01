			...
			foreach(var currentListTime in listOfSlot)
			{
				...
				if (currentListTime.flag == 0)
				{
					foreach (var tempListTime in tempList)
					{
						...
						{
							if ((currentListTime.endHours == tempListTime.startHours && currentListTime.endMinute >= tempListTime.startMinute) || (currentListTime.endHours > tempListTime.startHours))
							{
